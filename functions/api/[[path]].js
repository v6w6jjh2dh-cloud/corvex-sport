...
function normalizePhone(value = '') {
  ...
  const raw=String(value||'').trim().replace(/[٠-٩۰-۹]/g,d=>digitMap[d]||d);
  ...
  else if(raw.startsWith('+'))digits='+'+digits;
...
المحافظة يجب أن تكون واحدة فقط من: عمان، الزرقاء، إربد، جرش، عجلون، المفرق، البلقاء، مادبا، الكرك، الطفيلة، معان، العقبة، الأغوار.
...
أي عنوان يحتوي "بحر ميت" أو "البحر الميت" أو "الأغوار" أو "الاغوار" اجعل المحافظة فيه "الأغوار" دائمًا، مع إبقاء العنوان الأصلي كاملًا داخل detailed_address.
...
اقرأ قيمة الطلب من صيغ مثل: السعر 17، 17 شامل السعر، 17 شامل التوصيل، 17 مع التوصيل، 17 وتوصيل، والسعر شامل التوصيل 17. عبارة "مع التوصيل" لها نفس معنى "شامل التوصيل" ولا تعبّر عن كمية.
