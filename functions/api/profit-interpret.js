...
const explicitMModel=text=>/(?:بلوزه|بلوزة|تيشرت|تيشيرت|تشرت|بلايز)\s*(?:حرف\s*)?(?:m6|m|م6|[اأإ]م6|[اأإ]م|م)(?=\s|$)|(?:^|\s)حرف\s*(?:m|م|[اأإ]م)(?=\s|$)|(?:^|\s)(?:m6|م6|[اأإ]م6)(?=\s|$)|(?:^|\s)m(?=\s|$)/i.test(String(text||''));
...
11) موديل M يُقبل فقط مع دليل ملابس واضح مثل "بلوزة M" أو "بلوزة ام" أو "حرف M/حرف ام" أو الرمز M6/ام6. لا تقبل كلمة "أم" العربية المنفردة كاسم بديل للموديل.
