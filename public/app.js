...
function findBestPlace(line){
  ...
  for(const p of JORDAN_PLACES){
    if(padded.includes(' ' + p + ' ')){
      matches.push({
        place:p,
        governorate:PLACE_TO_GOV.get(p) || '',
