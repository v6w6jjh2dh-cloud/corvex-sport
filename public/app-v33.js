...
async function newOrder(){
  ...
  c.innerHTML=`<div class="page-title"><div><h1>إضافة طلب</h1><div class="sub">Smart Parser V33 • Jordan Shipping Dictionary • الصق الطلب كامل أو عبّئ الحقول يدويًا</div></div></div>
  <div class="card">
